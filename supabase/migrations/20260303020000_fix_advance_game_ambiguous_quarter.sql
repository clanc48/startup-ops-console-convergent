-- Fix ambiguous "quarter" reference inside advance_game by qualifying the UPDATE target.
-- This migration intentionally redefines the function (even if prior migrations ran).
...
begin
 ...
 -- Optimistic lock: qualify the target table to avoid ambiguity with output column names.
